...
struct TextSubSurf {
    ...
    // Horrible Workaround for the wf::simple_texture_t not being movable:
    TextSubSurf() = default;
    TextSubSurf(TextSubSurf const &) = delete;
    TextSubSurf(TextSubSurf &&) noexcept {};
