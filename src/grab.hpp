...
class active_grab_t {
  protected:
    ...
    static std::unique_ptr<active_grab_t>
    try_activate(nonstd::observer_ptr<swayfire_t> plugin,
...
class active_button_drag_t : public active_grab_t {
  ...
  public:
    ...
    active_button_drag_t(nonstd::observer_ptr<swayfire_t> plugin,
...
class active_move_t : public active_button_drag_t {
  ...
  public:
    ...
    static std::unique_ptr<active_grab_t>
    construct(nonstd::observer_ptr<swayfire_t> plugin, node_t dragged);
};
